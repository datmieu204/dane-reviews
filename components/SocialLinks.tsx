...
export default function SocialLinks({ socials }: SocialLinksProps) {
  ...
  const links = [
    ...
    },
    {
      ...
      icon: (
        <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
          <path d="M0 3v18h24v-18h-24zm6.623 7.929l-4.623 5.712v-11.454l4.623 5.742zm-4.133-6.929h19.02l-9.51 7.42-9.51-7.42zm7.042 7.781l2.468 1.928 2.469-1.928 4.79 5.918h-14.517l4.79-5.918zm8.845-.852l4.623-5.742v11.454l-4.623-5.712z" />
        </svg>
      ),
    },
  ];

  const activeLinks = links.filter((item) => Boolean(item.url));
